...
const BlogPostPage = () => {
  ...
  const handleBlogSubmit = (e) => {
    ...
    if (blogTitle.trim() && blogContent.trim()) {
      ...
      dispatch(addPost(newPost)); // Save to Firebase and Redux
      setBlogTitle("");
      setBlogContent("");
  ...
  return (
    <div className="p-10">
      <form
        ...
        className="blog-form space-y-3 border-2 border-red-300 p-10 w-[800px] rounded-lg"
      >
        <div className="flex items-center space-x-9">
          <label className="font-bold font-serif text-xl text-white tracking-wider">
            Title
          </label>
          <input
            type="text"
        ...
        <div className="flex items-center space-x-2">
          ...
          <textarea
            ...
            rows="8"
            required
            className="w-full p-4 resize-none rounded"
          ></textarea>
        </div>

        <div className="flex justify-end space-x-2">
          <Button type="submit" size="sm" className="bg-light-green-800 hover:bg-light-green-900">
            Post
          </Button>
          <Button type="cancel" size="sm" className="bg-red-600 hover:bg-red-900"
...
//       dispatch(addPost({ title: blogTitle, content: blogContent, date: new Date() })); // Dispatch the addPost action
//       setBlogTitle("");
//       setBlogContent("");
